...
export default function LoginPage() {
  ...
  return (
    <div className="w-[90%] max-w-4xl mx-auto rounded-[29px] bg-white/83 border-2 border-white shadow-[0_0_9.9px_6px_rgba(0,0,0,0.25)] p-4 md:p-8">
      <div className="mb-10">
        <h1
          className="w-full mx-auto font-['Koulen'] text-[48px] md:text-[64px] lg:text-[48px] sm:text-[64px] md:text-[86px] font-normal text-brand-blue text-center select-none leading-none"
          style={{
        ...
        <p className="text-center font-['Instrument_Sans'] text-xl md:text-2xl lg:text-[1.5rem] sm:text-[24px] font-normal leading-normal text-brand-blue">
