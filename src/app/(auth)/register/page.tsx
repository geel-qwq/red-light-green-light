...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      <div className="absolute top-2 mb-5">
        <h1
          className="w-full max-w-118 mx-auto font-['Koulen'] text-[60px] text-brand-blue text-center select-none"
          style={{
      ...
      <div className="w-full max-w-5xl rounded-[29px] bg-white/83 border-2 border-white shadow-[0_0_9.9px_6px_rgba(0,0,0,0.25)] overflow-hidden mt-20">
        <div className="p-8">
